window.onload = function () {
        ...
        var chart1 = new CanvasJS.Chart("approvecontainer",{  
         ...
         notapproved = results[0].value; 
             ...
             //sindhutest  
               // var deltaY = results[0].value;      
                //var yVal = deltaY + dps1[i].y > 0 ? dps1[i].y + deltaY : 0;
                var app = approved ;
                var rej = notapproved;
                var leg = dps1[i].label;
                var statusColor;
                ...
                dps1[0] = {label: 'Approved', y: app, color: statusColor};
                dps1[1] = {label: 'Rejected', y: rej, color: statusColor};
